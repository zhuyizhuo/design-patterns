...
public class ChainOfResponsibilityClient {
    ...
    public static void main(String[] args) {
        ...
        handler1.handleRequest(new Request("Negative Value ",  0));
        handler1.handleRequest(new Request("Negative Value ",  1));
        handler1.handleRequest(new Request("Negative Value ",  2));
        handler1.handleRequest(new Request("Negative Value ", -5));
    }
}